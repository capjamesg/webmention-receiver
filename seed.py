...
def create_tables():
    ...
    with connection:
        ...
        cursor.execute("CREATE TABLE webmentions (id integer primary key autoincrement, source, target, property, contents, author_name, author_photo, author_url, content_html, received_date, status);")
        ...
        cursor.execute("CREATE TABLE pending_webmentions (id integer primary key autoincrement, to_check);")
